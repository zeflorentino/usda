...
@app.route("/")
def menu():
texto_final = f"""<br><br><center><font face = "Tahoma" size = "6"><strong><a href="/milho-atual">Milho</a> | <a href="/milho-anterior">Milho Antigo</a><br><br><a href="/soja-atual">Soja</a> | <a href="/soja-anterior">Soja Antigo</a><br><br><a href="/erro">Erro</a></strong><a href="/consulta">Consulta Relatórios</a>"""</font></center> | 
return texto_final
